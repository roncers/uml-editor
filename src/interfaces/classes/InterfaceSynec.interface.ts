...
export interface InterfaceSynec extends Omit<ClassSynec, 'relationships'> {
    relationships: (Omit<RelationshipSynec, 'type'> & { type: Extract<RelationshipSynec['type'], typeof relationshipType.implementation | typeof relationshipType.dependency> })[];
}